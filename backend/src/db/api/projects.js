...
module.exports = class ProjectsDBApi {
  static async create(data, options) {
    ...
    await projects.setClient(data.client || null, {
      transaction,
    });

    await projects.setOrganization(currentUser.organization.id || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.client = await projects.getClient({
      transaction,
    });

    output.organization = await projects.getOrganization({
      transaction,
    });
  ...
  static async findAll(filter, globalAccess, options) {
    ...
    if (filter) {
      ...
      if (filter.title) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('projects', 'title', filter.title),
        };
      }
  ...
  static async findAllAutocomplete(query, limit, globalAccess, organizationId) {
    ...
    if (query) {
      where = {
        [Op.or]: [
          { ['id']: Utils.uuid(query) },
          Utils.ilike('projects', 'title', query),
        ],
      };
    }
