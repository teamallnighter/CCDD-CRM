    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Clients UserAccount</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.clients_user_account &&
                      Array.isArray(users.clients_user_account) &&
                      users.clients_user_account.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
              ...
              {!users?.clients_user_account?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
